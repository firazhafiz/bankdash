    ...
    <header className="flex flex-col gap-4 px-6py-5 md:flex-row md:items-center md:justify-between bg-white  p-5 md:px-[30px] md:py-5 border-b border-[#E6EFF5]">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-[20px] md:text-[28px] font-semibold text-[#343C6A]">{title}</h1>
        </div>
      ...
      <div className="flex flex-1 items-center justify-end gap-5 md:gap-[30px]">
        ...
        <div className="hidden md:flex items-center gap-[30px]">
           <Button size="icon" variant="ghost" className="rounded-full bg-[#F5F7FA] h-[50px] w-[50px] hover:bg-[#e6eff5]">
             <Settings className="h-6 w-6 text-[#718EBF]" />
           </Button>
           <Button size="icon" variant="ghost" className="rounded-full bg-[#F5F7FA] h-[50px] w-[50px] hover:bg-[#e6eff5] text-[#FE5C73]">
